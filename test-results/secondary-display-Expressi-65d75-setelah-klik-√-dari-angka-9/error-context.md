...
- Name: secondary-display.spec.js >> Expression Display Verification (Single Display Design) >> Scientific Mode >> display '3' setelah klik √ dari angka 9
- Location: tests\secondary-display.spec.js:48:9
