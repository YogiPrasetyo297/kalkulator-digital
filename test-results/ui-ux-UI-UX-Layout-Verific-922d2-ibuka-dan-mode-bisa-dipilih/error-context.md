...
- Name: ui-ux.spec.js >> UI/UX & Layout Verification >> Mobile Viewport — Fitur Spesifik >> hamburger menu bisa dibuka dan mode bisa dipilih
- Location: tests\ui-ux.spec.js:169:9
...
Locator: getByRole('button', { name: 'Scientific' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: 'Scientific' })
