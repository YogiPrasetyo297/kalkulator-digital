...
- Name: secondary-display.spec.js >> Expression Display Verification (Single Display Design) >> Standard Mode >> display '1' setelah klik angka 1
- Location: tests\secondary-display.spec.js:9:9
