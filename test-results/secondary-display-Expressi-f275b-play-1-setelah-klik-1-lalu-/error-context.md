...
- Name: secondary-display.spec.js >> Expression Display Verification (Single Display Design) >> Standard Mode >> display '1+' setelah klik 1 lalu +
- Location: tests\secondary-display.spec.js:14:9
