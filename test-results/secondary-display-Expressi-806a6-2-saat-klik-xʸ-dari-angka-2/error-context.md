...
- Name: secondary-display.spec.js >> Expression Display Verification (Single Display Design) >> Scientific Mode >> display '2^' saat klik xʸ dari angka 2
- Location: tests\secondary-display.spec.js:55:9
...
Call log:
  - waiting for getByRole('button', { name: 'xʸ', exact: true })
