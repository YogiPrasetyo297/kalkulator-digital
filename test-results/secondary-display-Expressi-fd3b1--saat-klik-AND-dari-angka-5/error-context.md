...
- Name: secondary-display.spec.js >> Expression Display Verification (Single Display Design) >> Programmer Mode >> display '5 AND ' saat klik AND dari angka 5
- Location: tests\secondary-display.spec.js:80:9
...
Call log:
  - waiting for getByRole('button', { name: 'AND', exact: true })
