...
- Name: ui-ux.spec.js >> UI/UX & Layout Verification >> Switch Mode — State Reset >> Scientific -> Programmer: display reset ke 0
- Location: tests\ui-ux.spec.js:46:9
...
Call log:
  - waiting for getByRole('button', { name: 'π' })
