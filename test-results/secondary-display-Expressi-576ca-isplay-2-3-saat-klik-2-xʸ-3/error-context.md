...
- Name: secondary-display.spec.js >> Expression Display Verification (Single Display Design) >> Scientific Mode >> display '2^3' saat klik 2, xʸ, 3
- Location: tests\secondary-display.spec.js:61:9
