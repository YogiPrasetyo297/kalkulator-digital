...
- Name: secondary-display.spec.js >> Expression Display Verification (Single Display Design) >> Standard Mode >> display '2' setelah klik =
- Location: tests\secondary-display.spec.js:27:9
