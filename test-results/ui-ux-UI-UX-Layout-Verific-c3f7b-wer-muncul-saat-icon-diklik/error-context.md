...
- Name: ui-ux.spec.js >> UI/UX & Layout Verification >> Mobile Viewport — Fitur Spesifik >> history drawer muncul saat icon diklik
- Location: tests\ui-ux.spec.js:187:9
...
Locator: getByRole('heading', { name: 'History', exact: true })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('heading', { name: 'History', exact: true })
...
- generic [ref=e1]:
  - main [ref=e2]:
    - generic [ref=e5]:
      ...
      - generic [ref=e18]:
        - generic [ref=e19]:
          - button "Lihat history" [active] [ref=e21]:
            - img [ref=e22]
